...
TestPass::TestPass()
{
    handlers.reg(AstKind::FILE, [](AstNode& node, ValuedResult& base, std::vector<ValuedResult>& childrenRes) {
    ...
    handlers.reg(AstKind::FUNC_DECL, [](AstNode& node, ValuedResult& res) {
