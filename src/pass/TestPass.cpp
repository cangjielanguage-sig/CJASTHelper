...
TestPass::TestPass()
{
    RegisterMergeHandler(AstKind::FILE, [](AstNode& node, ValuedResult& base, std::vector<ValuedResult>& childrenRes) {
    ...
    RegisterVisitHandler(AstKind::FUNC_DECL, [](AstNode& node, ValuedResult& res) {
