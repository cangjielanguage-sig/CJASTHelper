...
public:
     ...
     */
    virtual VisitResult BeforeVisit(AstNodePtr& node) = 0;
    /**
     * @brief 访问节点时调用的方法。
     *
     * @param node 要访问的 AST 节点。
     ...
     */
    virtual void Visit(AstNodePtr& node, VisitResult& res) = 0;
    /**
     * @brief 在访问节点之后调用的方法。
     *
     ...
     */
    virtual void AfterVisit(AstNodePtr& node, const VisitResult& res) = 0;
    /**
